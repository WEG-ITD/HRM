    ...
    <div class="m-1" style="margin:auto">
            ...
            >
                ...
                >
                    <v-card elevation="5">
                        <v-card-title>
                            Edit Language:  {{editing_Language.name}}?
                        </v-card-title>
                        <v-card-text>
                            <form>
                                <v-text-field
                                ...
                                <v-btn
                                color="success"
                                @click="editItem(editing_Language)"
                                >
                                Update
                            </v-btn>
                            <v-btn @click="clear">
    ...
    export default {
        ...
        data () {
            return {
                ...
                dialog:false,
                editDialog:false,
                deleting_Language:Object(),
                editing_Language:Object(),
                search: '',
        ...
        methods:{
            ...
            editItem (item) {
                axios
                .put("/api/languages/"+item.id,this.form)
                .then(response => {
